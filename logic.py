...
MANUAL_DIVIDEND_HISTORY = {
    ...
    'ALL-B': [('2025-07-01', 0.4860), ('2025-10-01', 0.4950), ('2025-12-31', 0.4684)],
    'ALL-PB': [('2025-07-01', 0.4860), ('2025-10-01', 0.4950), ('2025-12-31', 0.4684)],
    
    'WRB-F': [('2025-09-12', 0.31875), ('2025-12-12', 0.31875), ('2026-03-13', 0.31875)],
    'WRB-PF': [('2025-09-12', 0.31875), ('2025-12-12', 0.31875), ('2026-03-13', 0.31875)],
    
    'WRB-E': [('2025-09-12', 0.35625), ('2025-12-12', 0.35625), ('2026-03-13', 0.35625)],
    'WRB-PE': [('2025-09-12', 0.35625), ('2025-12-12', 0.35625), ('2026-03-13', 0.35625)],

    'WRB-H': [('2025-09-12', 0.328125), ('2025-12-12', 0.328125), ('2026-03-13', 0.328125)],
    'WRB-PH': [('2025-09-12', 0.328125), ('2025-12-12', 0.328125), ('2026-03-13', 0.328125)],

    'WRB-G': [('2025-09-12', 0.29375), ('2025-12-12', 0.29375), ('2026-03-13', 0.29375)],
    'WRB-PG': [('2025-09-12', 0.29375), ('2025-12-12', 0.29375), ('2026-03-13', 0.29375)],
    
    'NEE-N': [('2025-08-28', 0.3531), ('2025-11-26', 0.3531), ('2026-02-27', 0.3531)],
    'NEE-PN': [('2025-08-28', 0.3531), ('2025-11-26', 0.3531), ('2026-02-27', 0.3531)],

    'NEE-U': [('2025-08-28', 0.29375), ('2025-11-26', 0.29375), ('2026-02-27', 0.29375)],
    'NEE-PU': [('2025-08-28', 0.29375), ('2025-11-26', 0.29375), ('2026-02-27', 0.29375)],

    'CNO-A': [('2025-09-15', 0.3203), ('2025-12-15', 0.3203), ('2026-03-16', 0.3203)],
    'CNO-PA': [('2025-09-15', 0.3203), ('2025-12-15', 0.3203), ('2026-03-16', 0.3203)],
    
    'PCG-I': [('2025-10-31', 0.2725), ('2026-01-30', 0.2725), ('2026-04-30', 0.2725)],
    'PCG-PI': [('2025-10-31', 0.2725), ('2026-01-30', 0.2725), ('2026-04-30', 0.2725)],

    'GL-D': [('2025-10-15', 0.28125), ('2026-01-15', 0.28125), ('2026-04-15', 0.28125)],
    'GL-PD': [('2025-10-15', 0.28125), ('2026-01-15', 0.28125), ('2026-04-15', 0.28125)]
}
            ...
            for reb_day in reb_indices:
                try:
                    ...
                    events.append({
                        ...
                        'pre_3_diff': sanitize_val(diff_pre, 3),
                        'pre_3_pct': sanitize_val(perf_pre_pct, 4),
                        'post_3_diff': sanitize_val(diff_post, 3),
                        'post_3_pct': sanitize_val(perf_post_pct, 4),
                        'reba_body_diff': sanitize_val(reba_body_diff, 3),
                        'reba_body_pct': sanitize_val((reba_body_diff / reb_bar['Open'] * 100), 4) if reb_bar['Open'] > 0 else 0,
                        'reba_range_diff': sanitize_val(reba_range_diff, 3),
